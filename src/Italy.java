...
class Italy {
    ...
    private static Club INTER = new Club(3, "Internazionale", 1892, STADIUM, "Milan", SERIE_A,
    ...
    private static Club CHIEVO = new Club(20, "Chievo", 1886, STADIUM, "Verona", SERIE_A,
            new Glory(0, 0, 0, 0, 0, 0, 0),
            100, 100, 100, OWNER, COACH, new HashSet<>(), new Season(
            new League(0, 0, 0, 0, 0, 0, 0, 0),
            new Cup(), new Cup(), new ChampionsLeague(), 100, 100));
