class Spain {
    ...
    private static Club OSASUNA = new Club(18, "CA Osasuna", 1886, STADIUM, "Pamplona", LEAGUE,
            new Glory(0, 0, 0, 0, 0, 0, 0),
            100, 100, 100, OWNER, COACH);

    private static Club GRANADA = new Club(19, "Granada CF", 1886, STADIUM, "Granada", LEAGUE,
            new Glory(0, 0, 0, 0, 0, 0, 0),
            100, 100, 100, OWNER, COACH);
