...
class England {
    ...
    private static Club CARDIFF = new Club(18, "Cardiff City", 1886, STADIUM, "Cardiff", LEAGUE,
            new Glory(0, 0, 0, 0, 0, 0, 0),
            100, 100, 100, OWNER, COACH, new HashSet<>(), new Season(
            new League(0, 0, 0, 0, 0, 0, 0, 0),
            new Cup(), new Cup(), new ChampionsLeague(), 100, 100));

    private static Club FULHAM = new Club(19, "Fulham", 1886, STADIUM, "London", LEAGUE,
            new Glory(0, 0, 0, 0, 0, 0, 0),
            100, 100, 100, OWNER, COACH, new HashSet<>(), new Season(
            new League(0, 0, 0, 0, 0, 0, 0, 0),
            new Cup(), new Cup(), new ChampionsLeague(), 100, 100));

    private static Club HUDDERSFIELD = new Club(20, "Huddersfield Town", 1886, STADIUM, "Huddersfield", LEAGUE,
